...
import CocosHelper from "./platform/CocosHelper";
...
export default class ResMgr {
  ...
  /**增加静态资源依赖 */
  private _addTmpStaticDepends(completed: number, total: number, item: any) {
  ...
  public async loadForm(formName: string) {
    let form = await CocosHelper.loadResSync<cc.Prefab>(
      formName,
      cc.Prefab
      // this._addTmpStaticDepends.bind(this)
    );
    // this._clearTmpStaticDepends();
    // cc.loader deprecated
